(define (problem problema1)
    ...
    (:init (Em Corredor) ; Posicao inicial do agente
           ...
           (JanelaFechada J1) (JanelaFechada J2) (JanelaFechada J31) (JanelaFechada J32) ; Estado das janelas
           ...
           (Acesa Sala1) (Acesa Sala2) (Acesa Sala3) ; Estado das luzes
           (Apagada Sala4) (Apagada Sala5) (Apagada Sala6) ; Estado das luzes 
    )
